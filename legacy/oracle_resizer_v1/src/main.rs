...
// --- CONFIGURATION ---
const SRC_DIR: &str = "/workspace/plantclef/raw/pseudo_quadrats/";
const DST_DIR: &str = "/workspace/plantclef/processed/pseudo_quadrats_700px/";
const TARGET_SIZE: u32 = 700;
const JPEG_QUALITY: u8 = 85;
const MAX_THREADS: usize = 16; // ORACLE: Throttled to prevent Network Volume congestion
