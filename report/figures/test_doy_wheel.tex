...
\begin{scope}[shift={(-3.6, -5.4)}]
  % Each entry is one swatch + label group; entries spaced 2.0 apart.
  % Labels are intentionally short; the "exact vs aggregate" distinction
  % is in the figure caption, not duplicated here.
  % Entry 1: Aug
  ...
  % Entry 2: Jul
  \draw[fill=orange!25, draw=orange!70, line width=0.3pt] (2.0, 0) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (2.32, 0.09)
    {Jul (517)};

  % Entry 3: Apr–Jun
  \draw[fill=blue!18, draw=blue!55, line width=0.3pt] (4.0, 0) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (4.32, 0.09)
    {Apr--Jun (607)};

  % Entry 4: Sep–Mar
  \draw[fill=gray!18, draw=gray!50, line width=0.3pt] (6.2, 0) rectangle ++(0.25, 0.18);
  \node[anchor=west, font=\sffamily\scriptsize] at (6.52, 0.09)
    {Sep--Mar (313)};
\end{scope}
