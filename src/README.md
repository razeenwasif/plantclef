...
This directory contains the core Python library and building blocks for the plantclef engine.
...
- **`setup/`**: The `launch.sh` orchestrator script that manages DDP execution and hardware environment variables.
