"""ORACLE cluster manifest + per-host topology resolution.
...
can query for "what env vars should this host export to ``launch_oracle.sh``?"
...
Public surface:
    ...
    env = m.env_for(me)                # dict[str, str] for launch_oracle.sh
"""
