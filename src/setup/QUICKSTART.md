...
scp -P <port> -r src/setup/ root@<pod-ip>:/workspace/plantclef/src/setup/
```
...
```bash
tmux new -s download
bash src/setup/download_datasets.sh
...
python3 src/setup/seafile_downloader.py \
...
python3 src/setup/upload_to_kaggle.py --what all

# Or upload individually
python3 src/setup/upload_to_kaggle.py --what train
python3 src/setup/upload_to_kaggle.py --what pseudo
python3 src/setup/upload_to_kaggle.py --what models
```
...
- Try the Python downloader: `python3 src/setup/seafile_downloader.py --url <URL> --output <DIR>`
