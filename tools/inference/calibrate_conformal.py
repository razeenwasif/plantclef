...
def calibrate() -> None:
    ...
    # 2. Load Model (ORACLE: Use latest SWA weights)
    if is_master: print("[Calibration] Loading model...")
    # ORACLE: Padded to 7808 for Blackwell FP8 alignment
    ...
    best_ckpt = getattr(config, "SWA_CKPT_PATH", "models/cuda_deep_sat/oracle_s9999/swa_model_final.pth")
    ...
    # 3. Load Validation Data (ORACLE: Use high-speed DALI)
    ...
    if world_size > 1:
        # ORACLE: Use gather_object for non-tensor collections
